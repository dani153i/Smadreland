...
public class Account implements Serializable {
    ...
    // join account and account_role(s)
    @JoinTable(
    ...
    public Account(String firstName, String lastName, String email, String password, Boolean active) {
    ...
    public Account(String firstName, String lastName, String email, String password, Boolean active, Collection < AccountRole > roles) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        this.password = password;
